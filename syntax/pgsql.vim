...
syn keyword sqlType	smallint int integer bigint 
syn keyword sqlType     decimal numeric real double precision serial bigserial
syn keyword sqlType     money
syn keyword sqlType     character varying varchar text
syn keyword sqlType     bytea
syn keyword sqlType     timestamp with without time zone date time interval
syn keyword sqlType     boolean
syn keyword sqlType     point line lseg box path path polygon circle
syn keyword sqlType     cidr inet macaddr
syn keyword sqlType     bit varying
syn keyword sqlType     tsvector
